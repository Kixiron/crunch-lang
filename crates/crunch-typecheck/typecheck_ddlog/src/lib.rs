...
pub fn prog(__update_cb: Box<dyn CBFn>) -> Program {
    ...
    let __MultiHead_0 = Relation {
                            ...
                            rules:        vec![
                                /* __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))] :- InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)], (not hir::has_unknown_types(func)), (var path: internment::Intern<std::Vec<hir::StrT>>) = hir::path(func), (var signature: hir::Signature) = hir::signature(func). */
                                Rule::ArrangementRule {
                                    description: "__MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))] :- InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)], (not hir::has_unknown_types(func)), (var path: internment::Intern<std::Vec<hir::StrT>>) = hir::path(func), (var signature: hir::Signature) = hir::signature(func).".to_string(),
    ...
    let __MultiHead_1 = Relation {
                            ...
                            rules:        vec![
                                /* __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))] :- InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)], hir::has_unknown_types(func), var message = FlatMap(hir::unknown_type_errors(func)), (var path: internment::Intern<std::Vec<hir::StrT>>) = hir::path(func), (var signature: hir::Signature) = hir::corrected_signature(func). */
                                Rule::ArrangementRule {
                                    description: "__MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))] :- InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)], hir::has_unknown_types(func), var message = FlatMap(hir::unknown_type_errors(func)), (var path: internment::Intern<std::Vec<hir::StrT>>) = hir::path(func), (var signature: hir::Signature) = hir::corrected_signature(func).".to_string(),
                                    arr: ( Relations::InputItems as RelId, 0),
                                    xform: XFormArrangement::Join{
                                               description: "InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)]".to_string(),
                                               ffun: None,
                                               ...
                                               next: Box::new(Some(XFormCollection::FlatMap{
                                                                       ...
                                                                       next: Box::new(Some(XFormCollection::FilterMap{
                                                                                               description: "head of __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))] :- InputItems[(InputItems{.id=(_: bit<64>), .item=(hir::ItemFunc{.func=(func_id: bit<64>)}: hir::Item)}: InputItems)], InputFunctions[(InputFunctions{.id=(func_id: bit<64>), .func=(func: internment::Intern<hir::Function>)}: InputFunctions)], hir::has_unknown_types(func), var message = FlatMap(hir::unknown_type_errors(func)), (var path: internment::Intern<std::Vec<hir::StrT>>) = hir::path(func), (var signature: hir::Signature) = hir::corrected_signature(func)." .to_string(),
                                                                                               fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                                                               {
    ...
    let Errors = Relation {
                     ...
                     rules:        vec![
                         /* Errors[(Errors{.message=message}: Errors)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]. */
                         Rule::CollectionRule {
                             description: "Errors[(Errors{.message=message}: Errors)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))].".to_string(),
                             rel: Relations::__MultiHead_1 as RelId,
                             xform: Some(XFormCollection::FilterMap{
                                             description: "head of Errors[(Errors{.message=message}: Errors)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]." .to_string(),
                                             fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                             {
    ...
    let Functions = Relation {
                        ...
                        rules:        vec![
                            /* Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))]. */
                            Rule::CollectionRule {
                                description: "Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))].".to_string(),
                                rel: Relations::__MultiHead_0 as RelId,
                                xform: Some(XFormCollection::FilterMap{
                                                description: "head of Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))]." .to_string(),
                                                fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                {
                            ...
                            /* Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]. */
                            Rule::CollectionRule {
                                description: "Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))].".to_string(),
                                rel: Relations::__MultiHead_1 as RelId,
                                xform: Some(XFormCollection::FilterMap{
                                                description: "head of Functions[(Functions{.func=func_id}: Functions)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]." .to_string(),
                                                fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                {
                                                    let (ref path, ref signature, ref message, ref func_id) = match unsafe {  Value::__Tuple4__internment_Intern__std_Vec____Bitval32_hir_Signature___Stringval___Bitval64::from_ddvalue_ref(&__v) }.0 {
                                                        (ref path, ref signature, ref message, ref func_id) => ((*path).clone(), (*signature).clone(), (*message).clone(), (*func_id).clone()),
    ...
    let SymbolTable = Relation {
                          ...
                          rules:        vec![
                              /* SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))]. */
                              Rule::CollectionRule {
                                  description: "SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))].".to_string(),
                                  rel: Relations::__MultiHead_0 as RelId,
                                  xform: Some(XFormCollection::FilterMap{
                                                  description: "head of SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_0[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (func_id: bit<64>))]." .to_string(),
                                                  fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                  {
                                                      let (ref path, ref signature, ref func_id) = match unsafe {  Value::__Tuple3__internment_Intern__std_Vec____Bitval32_hir_Signature___Bitval64::from_ddvalue_ref(&__v) }.0 {
                                                          (ref path, ref signature, ref func_id) => ((*path).clone(), (*signature).clone(), (*func_id).clone()),
                              ...
                              /* SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]. */
                              Rule::CollectionRule {
                                  description: "SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))].".to_string(),
                                  rel: Relations::__MultiHead_1 as RelId,
                                  xform: Some(XFormCollection::FilterMap{
                                                  description: "head of SymbolTable[(SymbolTable{.path=path, .signature=signature}: SymbolTable)] :- __MultiHead_1[((path: internment::Intern<std::Vec<hir::StrT>>), (signature: hir::Signature), (message: string), (func_id: bit<64>))]." .to_string(),
                                                  fmfun: &{fn __f(__v: DDValue) -> Option<DDValue>
                                                  {
                                                      let (ref path, ref signature, ref message, ref func_id) = match unsafe {  Value::__Tuple4__internment_Intern__std_Vec____Bitval32_hir_Signature___Stringval___Bitval64::from_ddvalue_ref(&__v) }.0 {
                                                          (ref path, ref signature, ref message, ref func_id) => ((*path).clone(), (*signature).clone(), (*message).clone(), (*func_id).clone()),
