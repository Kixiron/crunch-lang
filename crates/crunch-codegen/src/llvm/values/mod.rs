...
pub enum Value<'ctx> {
    ...
    ConstArray(Array<'ctx>),
    ConstStruct(Struct<'ctx>),
    ConstVector(Vector<'ctx>),
    Undef(Undef<'ctx>),
    ConstInt(Int<'ctx>),
    ConstFloat(Float<'ctx>),
...
impl<'ctx> Value<'ctx> {
    pub(crate) fn from_val(val: Val<'ctx>) -> Self {
        match val.kind() {
            ...
            ValueKind::Function => Self::Function(Function::from_val(val)),
            ...
            ValueKind::ConstInt => Self::ConstInt(Int::from_val(val)),
...
impl_any_val! {
    BlockAddress, InlineAsm,
    Array, Struct, Vector, Float,
    NullPtr, Undef, Argument,
...
impl<'ctx> TryFrom<Value<'ctx>> for BlockAddress<'ctx> {
    ...
    fn try_from(val: Value<'ctx>) -> Result<Self, Self::Error> {
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct Array<'ctx>(Val<'ctx>);

impl<'ctx> Into<Value<'ctx>> for Array<'ctx> {
    fn into(self) -> Value<'ctx> {
        Value::ConstArray(self)
    }
}

impl<'ctx> TryFrom<Value<'ctx>> for Array<'ctx> {
    type Error = Error;
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct Struct<'ctx>(Val<'ctx>);

impl<'ctx> Into<Value<'ctx>> for Struct<'ctx> {
    fn into(self) -> Value<'ctx> {
        Value::ConstStruct(self)
    }
}

impl<'ctx> TryFrom<Value<'ctx>> for Struct<'ctx> {
    type Error = Error;
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct Vector<'ctx>(Val<'ctx>);

impl<'ctx> Into<Value<'ctx>> for Vector<'ctx> {
    fn into(self) -> Value<'ctx> {
        Value::ConstVector(self)
    }
}

impl<'ctx> TryFrom<Value<'ctx>> for Vector<'ctx> {
    type Error = Error;
...
#[derive(Copy, Clone, PartialEq, Eq, PartialOrd, Ord, Hash)]
#[repr(transparent)]
pub struct Float<'ctx>(Val<'ctx>);

impl<'ctx> Into<Value<'ctx>> for Float<'ctx> {
    fn into(self) -> Value<'ctx> {
        Value::ConstFloat(self)
    }
}

impl<'ctx> TryFrom<Value<'ctx>> for Float<'ctx> {
    type Error = Error;
